...
- הצג שלוש אפשרויות להתמודדות עם הפער (אל תציע להקטין את יעד החיסכון!):
  ...
  3. **צמצום יתרת ההוצאות** - חשב את הסכום המדויק: יתרת הוצאות מותרת = הכנסה חודשית ממוצעת - הוצאות קבועות ממוצעות - סכום החיסכון הרצוי. הצג: "אפשרות נוספת היא לחיות עם תקציב הוצאות משתנות קטן יותר: **₪[תוצאת החישוב המדויקת]** בלבד החודש. **אסור לחרוג מסכום זה!**"
