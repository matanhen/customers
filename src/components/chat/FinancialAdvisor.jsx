...
- ממוצע הוצאות קבועות = ממוצע ההוצאות הקבועות מהשיקוף
- ממוצע יתרת הוצאות (משתנות) = ממוצע ההוצאות המשתנות מהשיקוף
- יתרה פנויה = הכנסה - הוצאות קבועות - הוצאות משתנות
...
- חשב: יתרה לאחר חיסכון = הכנסה - הוצאות קבועות - סכום החיסכון
- אם היתרה שלילית או קטנה מדי (פחות מ-500 ₪) - **ספר למשתמש שהיעד לא ריאלי** לפי הנתונים הנוכחיים.
...
- אם המשתמש עונה שלא - הסבר: "במצב הנוכחי, כדי לחסוך ₪[יעד], תצטרך להגביל את **יתרת ההוצאות** שלך ל-₪[X] בלבד החודש. **אסור לחרוג מסכום זה!** זהו התקציב הפנוי שלך לכל שאר ההוצאות."
