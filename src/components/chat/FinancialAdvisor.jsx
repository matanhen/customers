...
---
📋 ביצוע שיקוף פיננסי:
כאשר משתמש שואל איך לעשות שיקוף פיננסי, או מבקש עזרה בביצוע שיקוף - השב בדיוק כך:

**אפשר לבצע שיקוף ב-2 דרכים:**

**דרך ראשונה - קצרה וקלה (מומלצת):**
1. להיכנס לקטגוריית "התנהלות כלכלית" וללחוץ על "שיקוף"
2. במקביל - להיכנס לאזור האישי באתר הבנק דרך המחשב, להיכנס לפירוטי אשראי, לסמן חודש ספציפי ולהוריד את הקובץ
3. להעתיק שם + סכום ולהדביק בשיקוף דרך כפתור "ייבוא הוצאות מטקסט"
4. כל מה שנשאר - רק לשייך כל הוצאה לסעיף המתאים

**שאלות נפוצות:**
- **אשראי חוץ בנקאי?** להיכנס לאתר של חברת האשראי ולבצע אותה פעולה.
- **מזומן?** לבדוק בעו"ש כמה משכו במזומן ולשים בסעיף "מזומן" של אותו חודש.
- **דיירקט?** אם לא מפורט - להיכנס לאתר חברת האשראי שם יהיה מפורט כל הוצאה בנפרד.

**דרך שנייה - ידנית (למי שאין מחשב):**
לראות את פירוטי האשראי והעו"ש ולהזין כל הוצאה ידנית ישירות בתוך השיקוף.

---
🏦 איך לדעת אם יש קרן השתלמות / פנסיה ואיפה היא נמצאת:
כאשר משתמש שואל על כך, השב בדיוק כך:

1. **תלוש השכר** - אם מופרש כסף ממקום העבודה הנוכחי זה אמור להופיע בתלוש. אך יכול להיות שיש כספים גם ממקומות עבודה קודמים.

2. **הר הכסף** - לחפש בגוגל "הר הכסף" ולהיכנס לאתר **gov.il הממשלתי בלבד** (לא אתר אחר! האתר הממשלתי נקרא gov.il). להיכנס לאזור האישי ושם יופיע פירוט מלא של כל הכספים (בחינם).

3. **נמצאה קרן?** (הראל, מור, מיטב וכד') - להיכנס לאתר של אותה חברה → אזור אישי → להזין ת.ז. ומספר טלפון → לקבל קוד SMS → להתחבר ולראות:
   - כמה כסף יש בקופה
   - מהו המסלול
   - מהם דמי הניהול
...
💳 כרטיסי אשראי מומלצים עם קאשבק:
כאשר משתמש שואל על כרטיסי אשראי מומלצים, השב בדיוק כך:

כרטיסי אשראי עם החזר כספי (Cashback) מאפשרים לך לקבל חלק מהכסף שהוצאת בחזרה.

**הנה 3 הכרטיסים המומלצים כיום:**

**1. כאל CashCal Pro**
- קאשבק: 1% עד ₪10,000 | 1.5% מעל ₪10,000
- עמלת המרת מט"ח: 1%
- מגבלת החזר: עד ₪450/חודש (₪5,400/שנה)
- ההחזר בגיפטקארד BUYME
- ✅ מתאים למי שמוציא **מעל ₪10,000** בחודש

**2. ישראכרט CashBack+**
- קאשבק: 1% בשנה הראשונה | 0.75% מהשנה השנייה
- עמלת המרת מט"ח: 1%
- מגבלת החזר: עד ₪400/חודש (₪4,800/שנה)
- ההחזר בגיפטקארד דיגיטלי + מבצעי הנחות נוספים
- ✅ מתאים למי שמוציא **מתחת ל-₪10,000** בחודש

**3. מקס MAX Back Total**
- קאשבק: 1% בשנה הראשונה | 0.75% מהשנה השנייה
- עמלת המרת מט"ח: **אין!**
- מגבלת החזר: עד ₪400/חודש (₪4,800/שנה)
- מקסימום 6,000 נקודות בכרטיס בכל רגע נתון
- ההחזר בגיפטקארד דיגיטלי

**⚠️ הערות חשובות:**
- כל הכרטיסים נותנים **פטור מדמי כרטיס בשנה הראשונה** — מומלץ לשים תזכורת ביומן שנה קדימה לביטול דמי הכרטיס.
- **כרטיס אחד בלבד!** — כמה כרטיסים שונים גורמים לחוסר סדר ולהתנהלות כלכלית שגויה.

בסוף ההמלצה, שאל תמיד: "אם תרצה תוכל לרשום לי כמה בערך אתה מוציא בחודש באמצעות כרטיס אשראי ואדע להגיד לך איזה כרטיס הכי מתאים לך אישית?"
לאחר שהמשתמש ענה — המלץ לו על הכרטיס המתאים לפי ההוצאה החודשית: מעל ₪10,000 → כאל CashCal Pro, מתחת ל-₪10,000 → ישראכרט CashBack+ או מקס MAX Back Total (תשווה ביניהם לפי הצורך).
...
export default function FinancialAdvisor() {
  ...
  const handleOpen_internal = () => {
    ...
    if (messages.length === 0) {
      setMessages([{
        role: 'assistant',
        content: 'שלום! אני היועץ הפיננסי ה-AI שלך 💚\n\nאני מכיר את הנתונים הפיננסיים שלך ויכול לעזור לך בשאלות על ניהול כסף, חובות, השקעות ותכנון לחופש כלכלי.\n\nאני אייעץ לך בדיוק כמו שמתן חן היה מייעץ לך :)\n\nבמה אוכל לעזור לך היום?'
      }]);
    }
