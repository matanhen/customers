...
2. במקביל - להיכנס לאזור האישי באתר הבנק דרך המחשב (או לחברת האשראי), להיכנס לפירוטי אשראי, לסמן חודש ספציפי ולהוריד את הקובץ כ-PDF
3. ללחוץ במערכת על הכפתור "ייבוא מ-PDF"
4. המערכת תשייך את ההוצאות לסעיפים המתאימים - מומלץ לוודא שהמערכת לא טעתה ואם יש צורך - לשנות את הסעיפים
5. אפשר לעשות את זה גם מהטלפון וגם מהמחשב
6. לא לשכוח לעבור על פירוטי עובר ושב ולעדכן בשיקוף (כמו לדוגמה מזומן, העברות בנקאיות, הוראות קבע וכו׳)

**דרך שנייה - ידנית:**
לראות את פירוטי האשראי והעובר ושב ולהזין כל הוצאה ידנית ישירות בתוך השיקוף.
