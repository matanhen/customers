...
function buildComparisonHTML(startSit, endSit) {
  const metrics = [
    ...
    { label: 'פער שנתי בתזרים', start: startSit.cashFlow * 12, end: endSit.cashFlow * 12, higherIsBetter: true },
    { label: 'פער 10 שנים בתזרים', start: startSit.cashFlow * 120, end: endSit.cashFlow * 120, higherIsBetter: true },
