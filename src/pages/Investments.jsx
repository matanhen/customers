          ...
          {SECTIONS.map((section) => {
            ...
            return (
              <button
                ...
                className={`bg-gradient-to-br ${section.color} text-white rounded-2xl p-5 md:p-8 text-right shadow-xl hover:scale-105 transition-transform duration-200 flex flex-col gap-4 min-h-[130px] md:min-h-[160px]`}
              >
